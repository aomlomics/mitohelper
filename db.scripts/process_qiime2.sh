...
# Import 12S sequences and taxonomies into QIIME2
...
# Remove sequences with >=5 ambiguous bases and homopolymers>=8bp long
qiime rescript cull-seqs --i-sequences 12S-seqs.qza --o-clean-sequences 12S-seqs-cleaned.qza

# Dereplicate cleaned sequences in uniq mode to retain identical sequence records with differing taxonomies
